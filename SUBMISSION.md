...
After publishing `v0.7.1`, download the plugin package:

https://github.com/twoer/self-drive-trip-planner/releases/download/v0.7.1/self-drive-trip-planner-plugin.zip
